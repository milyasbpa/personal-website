    ...
    <div className="max-w-5xl mx-auto lg:flex">
      ...
      >
        ...
        <p className="text-xs leading-relaxed max-w-xs text-[var(--fg-muted)]">
          Senior frontend engineer — design systems, performance, DX. Also studying 日本語 (JLPT
          N5).
        </p>

        {/* MIDDLE — interactive scrollspy navigation */}
        <nav aria-label="Sections" className="flex-1 flex flex-col justify-center py-4">
        ...
        <div className="flex items-center justify-between gap-2">
          <p className="text-[10px] font-mono leading-tight text-[var(--fg-subtle)]">
            © 2026 <span className="font-semibold text-[var(--accent)]">bas.</span>
            <br />
            Built with Next.js
          </p>
      ...
      <main className="lg:w-[54%] px-6 lg:pl-8 lg:pr-8 py-10 lg:py-12 flex flex-col gap-14">
        ...
        <div className="lg:hidden">
          <div className="flex items-center gap-3 mb-5">
            <NowBadge href="#now" statusText="Available for Work" />
          </div>
          <div className="flex items-center gap-4 mb-4">
            <ProfileAvatar size="md" showStatusBadge={true} />
            <div>
              <h1 className="text-2xl font-bold tracking-tight text-[var(--fg)]">Ilyas Bashirah</h1>
              <span className="font-mono font-bold text-sm text-[var(--accent)]">bas.</span>
            </div>
          </div>
          <p className="text-base leading-relaxed mb-5 text-[var(--fg-body)]">
            Crafting interfaces with intention. Senior frontend engineer focused on design systems and
            performance.
          </p>
